...
extern "C" {
#endif
void  hs_0_M_0_21__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val, U  I681, scalar  * I1312, U  did);
void  hs_0_M_0_2__decoder_4_to_16_tb_tb_daidir (UB  * pcode);
void  hs_0_M_0_9__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val, U  I681, scalar  * I1312, U  did);
void  hs_0_M_1_2__decoder_4_to_16_tb_tb_daidir (UB  * pcode);
void  hs_0_M_2_21__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_1__decoder_4_to_16_tb_tb_daidir (UB  * pcode, scalar  val, U  I681, scalar  * I1312, U  did);
void  hs_0_M_2_2__decoder_4_to_16_tb_tb_daidir (UB  * pcode);
void  hs_0_M_2_5__decoder_4_to_16_tb_tb_daidir (UB  * pcode, UB  val);
